<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Satisfy1.aspx.cs" Inherits="Exercise_Satisfy1"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <script type="text/javascript">
        $(function() {
            $("#<%=GridView1.ClientID%>").toSuperTable({ width: "850px", height: "500px",cssSkin: "sDefault",fixedCols: 1  });
        });
    </script>
    ...
    <h3 ><asp:Label ID="desc" runat="server" Text="Label"></asp:Label></h3>
     <div style="text-align:left">
            <asp:GridView ID="GridView1" runat="server" 
                ...
                PageSize="20" Width="940px" Font-Size="11px">
