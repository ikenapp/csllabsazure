...
public partial class Exercise_PreTest2 : System.Web.UI.Page
{
    String labid = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            //Keep State
            UserDAO.setInputsToSession("PreTest2", GridView1, labid);
        }
    ...
    protected void FinishButton_Click(object sender, EventArgs e)
    {
        ...
        using (LabsDBEntities db = new LabsDBEntities())
        {
            ...
            else
            {
                ...
                if (u != null)
                {
                    UserDAO.SaveStatus(u, db, "Part0");
                }

                db.SaveChanges();
                Response.Redirect("~/Exercise/PreTest3.aspx?surveyid=" + surveyid + "&labid=" + labid);
            }
        }
    }
}