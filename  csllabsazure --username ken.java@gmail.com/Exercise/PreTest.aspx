<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="PreTest.aspx.cs" Inherits="Exercise_PreTest" %>
...
<div style="text-align:center;width:100%">
    <asp:Button ID="StartButton" runat="server" Text="填寫前測問券 >>" CssClass="Next" 
        PostBackUrl="~/Exercise/PreTest1.aspx" />
        </div>
</asp:Content>
