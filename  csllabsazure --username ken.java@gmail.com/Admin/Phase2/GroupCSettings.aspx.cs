...
public partial class Admin_GroupCSettings : System.Web.UI.Page
{
    String labid = "";
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            using (LabsDBEntities db = new LabsDBEntities())
            {
                ...
                {
                    Preview.NavigateUrl = "~/Admin/Phase2/PreviewSurveyC.aspx?surveyid=" + s.sid + "&labid=" + labid + "&preview=true";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            FileUpload1.SaveAs(Server.MapPath(@"~/Upload/Lab_" + labid + "_GroupC.csv"));
    ...
    protected void SurveyImport_Click(object sender, EventArgs e)
    {
        ...
        using (LabsDBEntities db = new LabsDBEntities())
        {
            using (StreamReader sr = new StreamReader(Server.MapPath(@"~/Upload/Lab_" + labid + "_GroupC.csv"), System.Text.Encoding.Default))
            {
                //讀取文字檔
        ...
        else
        {
            ...
            PreviewLink.PostBackUrl = "~/Admin/Phase2/PreviewSurveyC.aspx?surveyid=" + surveyId+"&labid="+labid;
