...
public partial class Admin_Survey : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //if (!Page.IsPostBack)
        {
            ...
            {
                foreach (var s in db.Surveys.Where(c => c.labid == lab_id && c.surveyid == 24))
                {
    ...
    protected void SurveyImport_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            PreviewLink.PostBackUrl = "~/Admin/Phase2/PreviewPostTest.aspx?surveyid=" + surveyId + "&labid=" + labid;
