<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="PreviewSurveyC.aspx.cs" Inherits="Admin_PreviewSurveyC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
 ...
 <div style="text-align:center">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
            DataKeyNames="sid" DataSourceID="SqlDataSource1" Width="950px" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="question" HeaderText="題目" 
