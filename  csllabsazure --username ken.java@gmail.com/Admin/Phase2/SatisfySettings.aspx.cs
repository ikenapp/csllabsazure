...
public partial class Admin_SatisfySettings : System.Web.UI.Page
{
    String labid = "";
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //if (!Page.IsPostBack)
        {
            ...
            {
                foreach (var s in db.Surveys.Where(c => c.labid == lab_id && c.surveyid == 25))
                {
                    Preview.NavigateUrl = "~/Admin/Phase2/PreviewSatisfy.aspx?surveyid=" + s.sid + "&labid=" + labid + "&preview=true";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            FileUpload1.SaveAs(Server.MapPath(@"~/Upload/Lab_" + labid + "_Satisfy.csv"));
    ...
    protected void SurveyImport_Click(object sender, EventArgs e)
    {
        ...
        using (LabsDBEntities db = new LabsDBEntities())
        {
            using (StreamReader sr = new StreamReader(Server.MapPath(@"~/Upload/Lab_" + labid + "_Satisfy.csv"), System.Text.Encoding.Default))
            {
                //讀取文字檔
        ...
        else
        {
            ...
            PreviewLink.PostBackUrl = "~/Admin/Phase2/PreviewSatisfy.aspx?surveyid=" + surveyId+"&labid="+labid;
