<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DiscussionC.aspx.cs" Inherits="Discussion_DiscussionC" %>
    ...
    <div style="text-align:left;width:100%;">
        ...
        <asp:Label ID="LabInfo" runat="server" CssClass="login" Text="Label"></asp:Label>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                ...
                ForeColor="#333333" GridLines="None" ShowHeader="False" Width="940px" 
