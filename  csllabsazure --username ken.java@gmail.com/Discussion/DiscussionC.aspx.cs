...
public partial class Discussion_DiscussionC : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            if (u != null)
            {
                ...
                using (LabsDBEntities db = new LabsDBEntities())
                {
                    try
                    {
                        ...
                        Part2Title.Text = "一、" + question2.question1+"<button onclick='openNewWin()' >觀看前一週的作答</button>";
            ...
            //    {
            //        Session["PartB1"] = "[" + sb.ToString().Substring(1) + "]";
            //    }
            //}
            UserDAO.setInputsToSession("PartB1C_", "PartB1", GridView1, labid);
        }
