...
public partial class Admin_Survey : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            using (LabsDBEntities db = new LabsDBEntities())
            {
                ...
                {
                    Preview.NavigateUrl = "~/Admin/Phase1/PreviewSurvey.aspx?surveyid=" + s.sid + "&labid=" + labid + "&preview=true";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            FileUpload1.SaveAs(Server.MapPath(@"~/Upload/Lab_" + labid + "_Survey1.csv"));
    ...
    protected void SurveyImport_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            PreviewLink.PostBackUrl = "~/Admin/Phase1/PreviewSurvey.aspx?surveyid=" + surveyId+"&labid="+labid;
