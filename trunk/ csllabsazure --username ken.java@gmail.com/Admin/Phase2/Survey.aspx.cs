...
public partial class Admin_Survey2 : System.Web.UI.Page
{
    String labid = "";
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            FileUpload1.SaveAs(Server.MapPath(@"~/Upload/Lab_" + labid + "_Survey2.csv"));
    ...
    protected void SurveyImport_Click(object sender, EventArgs e)
    {
        ...
        using (LabsDBEntities db = new LabsDBEntities())
        {
            using (StreamReader sr = new StreamReader(Server.MapPath(@"~/Upload/Lab_" + labid + "_Survey2.csv"), System.Text.Encoding.Default))
            {
                //讀取文字檔
        ...
        else
        {
            ...
            PreviewLink.PostBackUrl = "~/Admin/Phase2/PreviewSurvey.aspx?surveyid=" + surveyId+"&labid="+labid;
