<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Survey.aspx.cs" Inherits="Admin_Survey2" %>
...
&nbsp;&nbsp;<asp:HyperLink ID="BackLink" runat="server">返回上一頁</asp:HyperLink><br>
   &nbsp;&nbsp;第二階段線上習作題目匯入
    ...
    <asp:HyperLink ID="Preview" runat="server" 
        NavigateUrl="~/Admin/Phase2/PreviewSurvey.aspx">已設定資料</asp:HyperLink>
   <br />
