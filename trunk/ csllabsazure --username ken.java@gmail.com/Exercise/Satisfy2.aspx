<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Satisfy2.aspx.cs" Inherits="Execise_Satisfy2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div style="text-align: center; width: 100%">
        <asp:Button ID="SaveAll" runat="server" Text="儲存" CssClass="centerBTN" OnClick="SaveAll_Click" />
    </div>
    <br>
    <script type="text/javascript" language="javascript">
        array = "<%= Session["Satisfy2"]%>";
