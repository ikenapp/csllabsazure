<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="SelfEvaluation.aspx.cs" Inherits="Execise2_SelfEvaluation" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div style="width:100%;">
    <h4><asp:Label ID="Tiele" runat="server" Text="第一部分:"></asp:Label></h4>
