...
public partial class Exercise_PreTest1 : System.Web.UI.Page
{
    String labid = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            //Keep State
            UserDAO.setInputsToSession("PreTest1", GridView1, labid);
        }
    }
    ...
    protected void NextButton_Click(object sender, EventArgs e)
    {
        ...
        using (LabsDBEntities db = new LabsDBEntities())
        {
            ...
            else
            {
                ...
                message = "";
                db.SaveChanges();
                Response.Redirect("~/Exercise/PreTest2.aspx?surveyid=" + surveyid + "&labid=" + labid);
            }
        }
    }
}